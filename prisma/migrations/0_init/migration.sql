...
-- AddForeignKey
ALTER TABLE "community" ADD CONSTRAINT "community_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
