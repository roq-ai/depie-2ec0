  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to depie - where influencers engage, publish, and monetize. Unleash your potential with our newsletters, broadcasts, paid FAQs, courses, and vibrant community discussions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556764900-fa065610b0e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbmZsdWVuY2Vyc3xlbnwwfHx8fDE2OTQzMzg4MTd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to depie - where influencers engage, publish, and monetize. Unleash your potential with our newsletters, broadcasts, paid FAQs, courses, and vibrant community discussions.`}
            </Text>
            <Box
